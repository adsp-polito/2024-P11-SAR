...
# Data handling
from training.extensions.focus_data_module import SARDataModule
...
class SARSegmentationModel(LightningModule):
    ...
    with a MobileNet encoder and class weights for handling imbalanced dataset.
    """
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.result_counter = save_prediction_images(masks, preds, counter=self.result_counter, result_folder='Deeplab_Focused')
