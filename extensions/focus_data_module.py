...
from custom_transforms import (ExtractFirstChannel, JointCompose, MaskToTensor, RandomizedFocusedCrop,
                               ProbabilisticRandomizedFocusedCrop, RandomizedFlip,
                               RandomizedResize)
        ...
        self.transforms_dict = {
            "train": {
                ...
                "joint": JointCompose([
                    RandomizedResize(),
                    RandomizedFlip(),
                    ProbabilisticRandomizedFocusedCrop(crop_transform=custom_transforms.RandomizedFocusedCrop(crop_size=320, max_shift=80),
                                                        crop_size=320,
                                                        probability=0.5)
                ])
            },
