...
class SARSegmentationModel(LightningModule):
    ...
    with a MobileNet encoder and class weights for handling the imbalanced dataset.
    """
    ...
    def __init__(self, learning_rate=5e-5, num_classes=5):
        ...
        # Define the DeeplabV3+ model with MobilenetV3
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.result_counter = save_prediction_images(masks, preds, counter=self.result_counter, result_folder='Deeplabv3')
