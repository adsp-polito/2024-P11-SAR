...
class SARSegmentationModel(LightningModule):
    ...
    This model uses a LinkNet architecture from the Segmentation Models PyTorch (smp) library,
    ...
    def __init__(self, learning_rate=5e-5, num_classes=5):
        ...
        # Define the LinkNet model with ResNet-101
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.result_counter = save_prediction_images(masks, preds, counter=self.result_counter, result_folder='LinkNet')
